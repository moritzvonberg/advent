...
def partially_overlap(range1: int, range2: int) -> bool:
    return (range1[0] >= range2[0] and range1[0] <= range2[1]) or (range1[1] >= range2[0] and range1[1] <= range2[1])

for range1, range2 in assignment_pairs:
    if partially_overlap(range1, range2) or fully_overlap(range1, range2):
